...
At every session start and check-in, read the new comments and checks on every open
PR before other work; do not wait for notifications. Closed and merged PRs are not
watched: never post there, and at every check-in sweep
