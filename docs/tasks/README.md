...
| [Development data inventory, 2017-08 to 2024-12](2026-09-25-bob-dev-data-inventory.md) | **Ran** in run 36203721612; report in PR #49, rechecked by Claude. |
| [V0 development scorecard (C1–C6, R1)](2026-09-25-bob-v0-dev-scorecard.md) | **Ran** in run 36203721612; report in PR #52, rechecked by Claude. |
| [Test-suite audit](2026-09-25-bob-test-suite-audit.md) | **Ran** in run 36203721612; report in PR #51, rechecked by Claude. |
| [Documentation audit](2026-09-25-bob-docs-audit.md) | **Ran** in run 36203721612; report in PR #50, rechecked by Claude. |
