...
| Codex / Bob (current revision) | Consolidation prepared by Codex; exact-head re-review and acknowledgment pending | All three agents must explicitly agree at the same resulting full head |
