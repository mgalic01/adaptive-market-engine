...
| --- | --- |
| [Claude → Codex: welcome back](2026-09-26-claude-handoff-codex-return.md) | 2026-09-26: Codex is back, so the stop-gap merge rule ends. #43–#68 are listed for after-the-fact review; #33 waits for Codex's agreement; three owner decisions pending; what Codex does first, in order. |
...
| [Bob: refined parser rule](2026-09-26-bob-refined-parser-rule.md) | Narrow rule: 82 usable pair-months (confirmed). Refined rule: 99 usable pair-months (+17). Gains: 2019-06 (+8), 2021-12 (+9), LTCUSDT 2017-12 (+1). Loss: DOGEUSDT 2020-02 fails condition (c) (pre-existing 1-tick archive discrepancy, not introduced by the rule). 2017-12 BTC/ETH/BNB and all 2018-02 remain unusable under both rules. Open question: whether the DOGE discrepancy warrants a volume-drift-style tolerance policy (would bring total to 100). |
